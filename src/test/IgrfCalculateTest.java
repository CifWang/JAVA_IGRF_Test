...
public class IgrfCalculateTest {
	private double time;
	private float lat;
	private float lon;
	private float alt;
	...
	public IgrfCalculateTest(double t, float latitude,float longitude,float altitude)throws MWException{
	...
	public IgrfCalculateTest(double t,float latitude,float longitude,float altitude,String coordinate) throws MWException{
		this.time=t;
		this.lat=latitude;
		this.lon=longitude;
		this.alt=altitude;
	...
	public static void main(String[] args) throws MWException{
		...
		IgrfCalculateTest ic=new IgrfCalculateTest(time,-60,180,0);
